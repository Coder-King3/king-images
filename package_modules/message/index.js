...
class Message {
  ...
  setOption(options) {
    ...
    const time = isNaN(Number(options.duration))
      ? this.duration
...
function msgSuccess(msg, duration = 1500) {
  message.setOption({
    message: msg,
    type: 'success',
    duration
...
function msgError(msg, duration = 1500) {
  message.setOption({
    message: msg,
    type: 'error',
    duration
...
function msgWarning(msg, duration = 1500) {
  message.setOption({
    message: msg,
    type: 'warning',
    duration
...
function msgInfo(msg, duration = 1500) {
  message.setOption({ message: msg, duration })
}

export default new Message()
export { msgSuccess, msgError, msgWarning, msgInfo }
